...
/*
    TODO: 
        - Move general methods to Utils.rsc or create other files if necessary.
        - Unit and their complexity functions have to go to their own file. They have to be imported
          into main file and used to present the user with results
